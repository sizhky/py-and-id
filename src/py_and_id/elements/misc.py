...
class Mic(Element):
    ...
    def __init__(self, *d, **kwargs):
        ...
        self.segments.append(
            Segment([(0, -sph), (resheight, -sph)])  # Lower lead
        )
        self.segments.append(
...
class Motor(Element2Term):
    ...
    def __init__(self, *d, **kwargs):
        ...
        self.segments.append(
            Segment([(0, -mw), (0 - mw, -mw), (0 - mw, mw), (0, mw)])
        )
        self.segments.append(
            Segment([(1, -mw), (1 + mw, -mw), (1 + mw, mw), (1, mw)])
        )
    ...
    def __init__(
        ...
        **kwargs
        ...
        if ring:
            ...
            if dots:
                self.segments.append(
                    SegmentCircle((0, 0), radius, fill=fill, zorder=4)
                )
            self.segments.append(
                Segment(
                    [
        ...
        if dots:
            self.segments.append(
                SegmentCircle((0, tipy), radius, fill=fill, zorder=4)
            )
        self.segments.append(
            Segment(
                [
        ...
        if switch:
            ...
            self.segments.append(
                Segment([(0, tipy - swdy), (-swlen, tipy - swdy)])
            )
            self.segments.append(
        ...
        if ring and ringswitch:
            ...
            self.segments.append(
                Segment([(0, ringy + swdy), (-swlen, ringy + swdy)])
            )
            self.segments.append(
