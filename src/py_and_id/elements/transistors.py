...
class Bjt(Element):
    ...
    def __init__(self, *d, circle: bool = False, **kwargs):
        ...
        self.segments.append(
            Segment([(bjt_v, bjt_v_len / 2), (bjt_v, -bjt_v_len / 2)])
        )
        self.segments.append(
            Segment(
                [
...
class BjtPnp2c(BjtPnp):
    ...
    def __init__(self, *d, circle: bool = False, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(bjt_v, -bjt_a - bjt_2c_dy), (bjt_emx, -bjt_emy - bjt_2c_dy)]
            )
        )
...
class Bjt2(Element2Term):
    ...
    def __init__(self, *d, circle: bool = False, **kwargs):
        ...
        if circle:
            self.segments.append(
                SegmentCircle((bjt_width / 2, bjt_r / 2), bjt_r)
            )
        self.params["lblloc"] = "bottom"
