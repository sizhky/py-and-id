...
class OutletB(OutletA):
    ...
    def __init__(self, *d, plug: bool = False, **kwargs):
        ...
        fill = "black" if plug else "bg"
        self.segments.append(
            SegmentPoly((list(zip(x, y))), fill=fill, zorder=3)
        )
...
class OutletD(Element):
    ...
    def __init__(self, *d, plug: bool = False, **kwargs):
        ...
        self.segments.append(SegmentCircle((x, y), prad, fill=fill, zorder=3))
        self.segments.append(
            SegmentCircle((0, y2), prad * 1.2, fill=fill, zorder=3)
        )
...
class OutletJ(Element):
    ...
    def __init__(self, *d, plug: bool = False, **kwargs):
        ...
        prad = _outletrad / 8
        self.segments.append(
            SegmentCircle((-fullw / 4, 0), prad, fill=fill, zorder=3)
        )
        self.segments.append(
            SegmentCircle((0, -prad * 2), prad, fill=fill, zorder=3)
        )
        self.segments.append(
            SegmentCircle((fullw / 4, 0), prad, fill=fill, zorder=3)
        )
...
class OutletK(Element):
    ...
    def __init__(self, *d, plug: bool = False, **kwargs):
        ...
        prongx = _outletrad / 2
        self.segments.append(
            SegmentCircle((-prongx, 0), prad, fill=fill, zorder=3)
        )
        self.segments.append(
            SegmentCircle((prongx, 0), prad, fill=fill, zorder=3)
        )
