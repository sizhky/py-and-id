...
class RotarySin(Rotary):
    ...
    def __init__(self, *d, **kwargs):
        ...
        sin_x = [
            0.2 * math.sin((sy - 0.25) * math.pi * 2 / 0.5) + 0.5
            for sy in sin_y
        ]
...
class RotaryControlled(Element2Term):
    ...
    def __init__(self, *d, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(0, 0), (0.5, 0.5), (1, 0), (0.5, -0.5), (0, 0), gap, (1, 0)]
            )
        )
...
class Solar(Rotary):
    ...
    def __init__(self, *d, **kwargs):
        ...
        self.segments.append(
            Segment([(cellx + 0.2, cellw2), (cellx + 0.2, -cellw2)])
        )
        self.segments.append(
...
class Neon(Rotary):
    ...
    def __init__(self, *d, **kwargs):
        ...
        self.segments.append(Segment([(cellx, cellw), (cellx, -cellw)]))
        self.segments.append(
            Segment([(cellx + 0.2, cellw), (cellx + 0.2, -cellw)])
        )
        self.segments.append(
            Segment([(0, 0), (cellx, 0), gap, (cellx + 0.2, 0), (1, 0)])
        )
        self.segments.append(
            SegmentCircle((cellx - 0.15, 0.2), 0.05, fill=True)
        )
