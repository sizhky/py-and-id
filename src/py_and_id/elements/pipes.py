        ...
        self.segments.append(
            Segment(  # Center conductor
                [
                    ...
                    (leadlen, 0),
                    gap,
                    (length - leadlen + radius / 2, 0),
                    (length, 0),
                ]
            )
        )
        self.segments.append(
            Segment([(leadlen, radius), (length - leadlen, radius)])
        )  # Top
        self.segments.append(
            Segment([(leadlen, -radius), (length - leadlen, -radius)])
        )  # Bottom
    ...
    def __init__(
        ...
        **kwargs
        ...
        xshield = (
            radiusouter
            / 2
            * math.sqrt(1 - radiusinner**2 / radiusouter**2)
        )
        ...
        if length - leadlen - shieldofstend + radiusouter < length:
            ...
            self.segments.append(
                Segment(
                    [
                        (
                            length - leadlen - shieldofstend + xshield,
                            radiusinner,
                        ),
                        (length - leadlen, radiusinner),
                    ]
                )
            ...
            self.segments.append(
                Segment(  # Center conductor
                    [
                        ...
                        gap,
                        (
                            length - leadlen - shieldofstend + radiusouter / 2,
                            0,
                        ),
                    ]
                )
        ...
        self.segments.append(
            Segment(  # guard (inner) top/left
                [
                    (leadlen, radiusinner),
                    (leadlen + shieldofststart + xshield, radiusinner),
                ]
            )
        )
        self.segments.append(
        ...
        self.segments.append(
            SegmentArc(
                (length - leadlen - shieldofstend, 0),
                width=radiusouter,
                height=radiusouter * 2,
                theta1=270,
                theta2=90,
        ...
        self.anchors["shieldstart_top"] = (
            leadlen + shieldofststart,
            radiusouter,
        )
        self.anchors["shieldend"] = (
            length - leadlen - shieldofstend,
            -radiusouter,
        )
        self.anchors["shieldend_top"] = (
            length - leadlen - shieldofstend,
            radiusouter,
        )
