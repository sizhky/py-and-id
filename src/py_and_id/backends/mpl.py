...
class Figure:
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get("ax"):
            ...
            self.fig.subplots_adjust(
                left=0.05, bottom=0.05, right=0.95, top=0.90
            )
    ...
    def arrow(
        ...
        fin1 = (
            util.Point((fullen - arrowlength, arrowwidth / 2)).rotate(theta)
            + tail
        )
        fin2 = (
            util.Point((fullen - arrowlength, -arrowwidth / 2)).rotate(theta)
    ...
    def getfig(self):
        ...
        if not self.userfig:
            ...
            x1 -= 0.1  # Add a bit to account for line widths getting cut off
            x2 += 0.1
            y1 -= 0.1
            y2 += 0.1
            try:
